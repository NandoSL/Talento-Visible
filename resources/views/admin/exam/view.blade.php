        ...
        <div class="ol-card">
            <div class="ol-card-body p-20px mb-3">
                ...
                {{-- Sidebar Tabs --}}
                    ...
                    <form action="{{ route('admin.exam.update', [$course_details->id, $exam->exam_settings_id ?? $exam->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        {{-- Content --}}
                        <div class="tab-content w-100">
                            <div class="row new-section pb-4 mb-4">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="title_exam" value="{{ $exam->title }}" class="form-control ol-form-control new-input mb-2" id="title_exam" required disabled>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="description_exam" value="{{ $exam->description }}" class="form-control ol-form-control new-input mb-2" id="description_exam" required disabled>
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="row"> 
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="opens" name="attempts" class="form-control ol-form-control new-input" disabled>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="waitingTime" name="waitingTime" class="form-control ol-form-control new-input" disabled>
                                ...
                                <div class="col-md-12">
                                    <label for="showResults" style="width: 100%; cursor: pointer;">
                                        <input class="ol-form-control mx-3" type="checkbox" id="showResults" value="1" name="showResults" {{ old('show_results', $exam->show_results) ? 'checked' : '' }} disabled>
                            ...
                            <div class="row new-section pb-4 mb-4">
                                ...
                                <div class="col-md-12">
                                    <label class="new-sub-section" for="course" style="width: 100%; cursor: pointer;">
                                        <input class="ol-form-control mx-3" type="checkbox" id="course" name="fullCourse" value="1" {{ old('fullCourse', $exam->course_completed) ? 'checked' : '' }} disabled>
                                        <span class="title1"
                                    ...
                                    <label class="new-sub-section" for="recording" style="width: 100%; cursor: pointer; border-color: #bedbff; background-color: #eef2ff;">
                                        <input class="ol-form-control mx-3" type="checkbox" id="recording" name="recording" value="1" {{ old('camera_screen_record', $exam->camera_screen_record) ? 'checked' : '' }} disabled>
                                    ...
                                    <label class="new-sub-section" for="person_detection" style="width: 100%; cursor: pointer; border-color: #e9d4ff; background-color: #fdf2f8;">
                                        <input class="ol-form-control mx-3" type="checkbox" id="person_detection" name="personDetection" value="1" {{ old('person_detection', $exam->person_detection) ? 'checked' : '' }} disabled>
                                        <span class="title fs-16">
                                    ...
                                    <label class="new-sub-section" for="window_detection" style="width: 100%; cursor: pointer; border-color: #fee685; background-color: #fff7ed;">
                                        <input class="ol-form-control mx-3" type="checkbox" id="window_detection" name="windowDetection" value="1" {{ old('window_detection', $exam->window_detection) ? 'checked' : '' }} disabled>
                                        <span class="title fs-16">
                                    ...
                                    <label class="new-sub-section" for="block" style="width: 100%; cursor: pointer; border-color: #ffc9c9; background-color: #fff1f2;">
                                        <input class="ol-form-control mx-3" type="checkbox" id="block" name="block" value="1" {{ old('keyboard_events', $exam->keyboard_events) ? 'checked' : '' }} disabled>
                                        <span class="title fs-16">
