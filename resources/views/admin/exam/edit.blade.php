...
@push('title', get_phrase('Edit Exam') . ' - ' . $course_details->title)
@push('css')
<style>
    .new-section {
        padding: 10px; 
        ...
        <div class="ol-card">
            <div class="ol-card-body p-20px mb-3">
                ...
                {{-- Sidebar Tabs --}}
                    ...
                    <form action="{{ route('admin.exam.update', [$course_details->id, $exam->exam_id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        {{-- Content --}}
                        ...
                        <div class="tab-content w-100">
                            <div class="row new-section pb-4 mb-4">
                                <div class="col-sm-12 col-form-label">
                                    <h4 class="title">Editar examen</h4>
                                    <label class="form-label sub-title-1">Edita tu examen completo desde la ultima versión que guardaste</label>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="title_exam" value="{{ $exam->title }}" class="form-control ol-form-control new-input mb-2" id="title_exam" required>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="description_exam" value="{{ $exam->description }}" class="form-control ol-form-control new-input mb-2" id="description_exam" required>
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="row"> 
                                        <div class="col-md-3">
                                            ...
                                            <input type="number" name="duration" value="{{ $exam->duration }}" class="form-control ol-form-control new-input" min="1">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="number" name="minScore" value="{{ $exam->pass_mark }}" class="form-control ol-form-control new-input" min="0">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="opens" name="attempts" class="form-control ol-form-control new-input">
                                                <option value="1" {{ $exam->retake == 1 ? 'selected' : '' }}>1 intento</option>
                                                <option value="2" {{ $exam->retake == 2 ? 'selected' : '' }}>2 intentos</option>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="waitingTime" name="waitingTime" class="form-control ol-form-control new-input" required>
                                                <option value="3" {{ $exam->hours == 3 ? 'selected' : '' }}>3 horas</option>
                                                <option value="6" {{ $exam->hours == 6 ? 'selected' : '' }}>6 horas</option>
                                                <option value="9" {{ $exam->hours == 9 ? 'selected' : '' }}>9 horas</option>
                                ...
                                <div class="col-md-12">
                                    <label for="showResults" style="width: 100%; cursor: pointer;">
                                        <input class="ol-form-control mx-3" type="checkbox" id="showResults" value="1" name="showResults" {{ old('show_results', $exam->show_results) ? 'checked' : '' }}>
                            ...
                            <div class="row new-section pb-3 mb-4">
                                ...
                                <div class="col-sm-4 col-form-label text-end pe-5">
                                    <a href="#" onclick="ajaxModal('{{ route('modal', ['admin.questions_exam.create', 'id' => $course_details->id]) }}', 'Añadir pregunta', 'modal-xl')" class="btn-add-question w-auto">
                            ...
                            <div class="row new-section pb-4 mb-4">
                                ...
                                <div class="col-md-12">
                                    <label class="new-sub-section" for="course" style="width: 100%; cursor: pointer;">
                                        <input class="ol-form-control mx-3" type="checkbox" id="course" name="fullCourse" value="1" {{ old('fullCourse', $exam->course_completed) ? 'checked' : '' }}>
                                        <span class="title1"
                                    ...
                                    <label class="new-sub-section" for="recording" style="width: 100%; cursor: pointer; border-color: #bedbff; background-color: #eef2ff;">
                                        <input class="ol-form-control mx-3" type="checkbox" id="recording" name="recording" value="1" {{ old('camera_screen_record', $exam->camera_screen_record) ? 'checked' : '' }}>
                                    ...
                                    <label class="new-sub-section" for="person_detection" style="width: 100%; cursor: pointer; border-color: #e9d4ff; background-color: #fdf2f8;">
                                        <input class="ol-form-control mx-3" type="checkbox" id="person_detection" name="personDetection" value="1" {{ old('person_detection', $exam->person_detection) ? 'checked' : '' }}>
                                        <span class="title fs-16">
                                    ...
                                    <label class="new-sub-section" for="window_detection" style="width: 100%; cursor: pointer; border-color: #fee685; background-color: #fff7ed;">
                                        <input class="ol-form-control mx-3" type="checkbox" id="window_detection" name="windowDetection" value="1" {{ old('window_detection', $exam->window_detection) ? 'checked' : '' }}>
                                        <span class="title fs-16">
                                    ...
                                    <label class="new-sub-section" for="block" style="width: 100%; cursor: pointer; border-color: #ffc9c9; background-color: #fff1f2;">
                                        <input class="ol-form-control mx-3" type="checkbox" id="block" name="block" value="1" {{ old('keyboard_events', $exam->keyboard_events) ? 'checked' : '' }}>
                                        <span class="title fs-16">
                            ...
                            <div class="row new-section pb-4 mb-4">
                                <div style="display: flex; align-items: center; justify-content: space-between; padding-top: 10px;">
                                    ...
                                    <div style="display: flex; gap: 12px">
                                        ...
                                        <button class="btn-2" type="submit" name="action" value="save_draft">Actualizar borrador</button>
