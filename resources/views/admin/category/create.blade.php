<form action="{{ route('admin.category.store') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="mb-3">
                <label for="category_name" class="form-label ol-form-label">{{ get_phrase('Category Name') }}dfdfd</label>
                <input type="text" name="title" class="form-control ol-form-control rounded-3" id="category_name" placeholder="{{ get_phrase('Enter your category name') }}"
            ...
            <div class="mb-3">
                ...
                <input type="text" name="icon" class="form-control ol-form-control icon-picker rounded-3" id="icon-picker" placeholder="{{ get_phrase('Pick your category icon') }}"
            ...
            <div class="mb-3">
                ...
                <input type="text" name="keywords" class="form-control ol-form-control rounded-3" id="Keywords" placeholder="{{ get_phrase('Enter your Keywords') }}"
            ...
            <div class="mb-3">
                ...
                <textarea name="description" rows="4" class="form-control ol-form-control rounded-3" id="description" placeholder="{{ get_phrase('Enter your description') }}"
            ...
            <div class="mb-3">
                ...
                <input type="file" name="category_logo" class="form-control ol-form-control rounded-3" id="category_logo" accept="image/*" />
            </div>
