    ...
    <div class="row g-2 g-sm-3 my-3 row-cols-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                ...
                <div class="ol-card card-hover">
                    <div class="ol-card-body px-20px py-3">
                        <div class="w-10 h-10  flex items-center justify-center rounded">
                            <i class="fi fi-rr-book-open-cover fs-30px p-2 txt-color bg-color-degraded"
                                style="--txt-color: #FFF;  --color1:#3B9FD0; --color2:#107BE3; border-radius:10%;"></i>
                        </div>
        ...
        <div class="col">
            <div class="ol-card card-hover">
                <div class="ol-card-body px-20px py-3">
                    <div class="w-10 h-10  flex items-center justify-center rounded">
                        <i class="fi fi-rr-file-spreadsheet fs-30px p-2 txt-color bg-color-degraded"
                            style="--txt-color: #FFF; --color1:#6111D1; --color2:#B487F2; border-radius:10%;"></i>
                    </div>
        ...
        <a href="{{ route('admin.enroll.history') }}">
            <div class="col">
                <div class="ol-card card-hover">
                    <div class="ol-card-body px-20px py-3">
                        <div class="w-10 h-10  flex items-center justify-center rounded">
                            <i class="fi fi-rr-users-alt fs-30px p-2 txt-color bg-color-degraded"
                                style="--txt-color: #FFF; --color1:#50F350; --color2:#009C00; border-radius:10%;"></i>
                        </div>
        ...
        <a href=" {{ route('admin.student.index') }} ">
            <div class="col">
                <div class="ol-card card-hover">
                    <div class="ol-card-body px-20px py-3">
                        <div class="w-10 h-10  flex items-center justify-center rounded">
                            <i class="fi fi-rr-users fs-30px p-2 txt-color bg-color-degraded"
                                style="--txt-color: #FFF; --color1:#FF9302; --color2:#BA6A00; border-radius:10%;"></i>
                        </div>
        ...
        <a href=" {{ route('admin.instructor.index') }} ">
            ...
            <div class="col">
                <div class="ol-card card-hover">
                    <div class="ol-card-body px-20px py-3">
                        <div class="w-10 h-10  flex items-center justify-center rounded">
                            <i class="fi fi-rr-graduation-cap fs-30px p-2 txt-color bg-color-degraded"
                                style="--txt-color: #FFF; --color1:#F0027F; --color2:#970050; border-radius:10%;"></i>
                        </div>
                        <p class="title card-title-hover fs-18px my-2">
