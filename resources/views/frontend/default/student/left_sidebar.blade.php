...
@endphp
<div class="sidebar-menu {{ $sidebar ? 'disabled-sidebar' : '' }}" id="sidebar-menu-lateral" style="width: 15%">
    <div class="gradient-border">
        <div class="course-sideBar">
            <div class="sidebar-menu-izq">
                <button id="sidebar-btn-menu">
                        <i class="fi fi-rr-menu-burger"></i>
                </button>
            </div>
            <span>
                @if ($current_route === 'my.profile')
                ...
                @else
                    <div class="profile-info">
                        <a href="{{ route('home') }}">
                            <img class="logo-photo" src="{{ asset('assets/frontend/Tv/images/LogoOk.png') }}"
                                alt="Logo">
                        </a>
                        {{-- <h5 class="name">{{ get_settings('system_title') }}</h5> --}}
                        <p class="email">{{ auth()->user()->name }}</p>
                        {{--<p class="email">{{ auth()->user()->email }}</p>--}}
                    </div>
                @endif
            </span>
            ...
            <ul class="couses-tab-list">
                ...
                <li class="@if ($current_route == 'my.courses') active @endif">
                    <a href="{{ route('my.courses') }}"
                        class="{{ $current_route == 'my.courses' ? 'disabled-link' : '' }}">
                ...
                <li class="@if (
                    $current_route == 'my.team.packages' ||
                        $current_route == 'my.team.packages.details' ||
                        $current_route == 'team.package.invoice') active team-active @endif">
                ...
                @if (auth()->user()->role == 'student')
                    <li class="@if ($current_route == 'team.members') active member-active @endif">
                        <a href="{{ route('team.members') }}"
                            class="{{ $current_route == 'team.members' ? 'disabled-link' : '' }}">
                ...
                <li class="@if ($current_route == 'my.profile') active profile-active @endif">
                    <a href="{{ route('my.profile') }}"
                        class="{{ $current_route == 'my.profile' ? 'disabled-link' : '' }}">
                ...
                <li class="@if ($current_route == 'wishlist') active whish-active @endif">
                    <a href="{{ route('wishlist') }}"
                        class="{{ $current_route == 'wishlist' ? 'disabled-link' : '' }}">
                ...
                <li class="@if ($current_route == 'message') active msg-active @endif">
                    <a href="{{ route('message') }}" class="{{ $current_route == 'message' ? 'disabled-link' : '' }}">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <li class="@if ($current_route == 'purchase.history' || $current_route == 'invoice') active history-active @endif">
                    <a href="{{ route('purchase.history') }}"
                        class="{{ $current_route == 'purchase.history' ? 'disabled-link' : '' }}">
