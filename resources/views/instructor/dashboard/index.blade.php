        ...
        <div class="ol-card p-3">
            <div class="d-flex align-items-start mb-3">
                ...
                <div class="text-end ms-2">
                    <a class="btn-link" href="{{ route('instructor.payout.reports') }}" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{ get_phrase('Instructor Revenue') }}">
   ...
   <div class="col-lg-6 col-xl-6 mb-3">
        <div class="ol-card p-3">
            <div class="d-flex align-items-start mb-3">
                ...
                <div class="text-end ms-2">
                    <a class="btn-link" href="{{ route('instructor.courses') }}" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{ get_phrase('Explore Courses') }}">
                        <i class="fi-rr-arrow-alt-right"></i>
                    </a>
                </div>
            </div>
        ...
        <div class="ol-card-body p-3">
            ...
            <div class="row align-items-center p-3"> <div class="col-auto d-flex align-items-center me-3">   <div class="icon-money-large">
             <i class="fas fa-dollar-sign"></i> </div> 
    </div>
    
    <div class="col"> <h4 class="title text-20px mb-0 fw-bold"> 
        ...
        <p class="text-muted text-14px mb-0">
            ...
            @else
                <div class="d-flex flex-column align-items-center justify-content-center py-5 text-center">
                    ...
                    <p class="text-muted">{{ get_phrase('When you make a withdrawal request, it will appear here') }}</p>
                </div>
            @endif
        </div>
    </div>
