    ...
    <div class="col-12">
        <div class="ol-card">
            <div class="ol-card-header d-flex justify-content-between align-items-center p-3">
                <h4 class="m-0 titulo-bootcamp">{{ get_phrase('Add New Package') }}</h4>
            </div>
                        ...
                        <div id="feature_area">
                            ...
                            <div id = "blank_feature_field">
                                <div class="d-flex mb-3 gap-3">
                                    <div class="flex-grow-1">
                                        <div class="form-group">
                                            <input type="text" class="form-control ol-form-control" name="features[]" placeholder="{{ get_phrase('Provide package features') }}">
                                        </div>
                                    </div>
                                    <div class="">
                             ...
                             <div class="mb-3">
                        <label class="form-label ol-form-label" for="estimated_price_input">{{ get_phrase('Estimated Price') }}</label>
                        <div class="d-flex mb-3 gap-3">
                            <div class="flex-grow-1">
                                <div class="form-group">
                                    <input type="text" class="form-control ol-form-control" id="estimated_price_input" value="{{ get_phrase('First select course privacy') }}" readonly>
                                </div>
                            </div>
                            <div class="">
                                <button type="button" class="btn ol-btn-primary ol-icon-btn" name="button" data-bs-toggle="tooltip" title="{{ get_phrase('Add new price logic') }}">
